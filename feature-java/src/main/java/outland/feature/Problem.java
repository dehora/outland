...
public class Problem {
  ...
  static final URI MISSING_FEATURE_TYPE = URI.create("about:missing_feature");
  private static final URI DEFAULT_TYPE = URI.create("about:blank");
  private static final URI LOCAL_TYPE = URI.create("about:local");
  private static final URI CONFIG_TYPE = URI.create("about:local_config");
  private static final URI MISSING_PROBLEM_TYPE = URI.create("about:missing_problem");
  ...
  private static final Map SENTINEL_MAP = ImmutableMap.of();
  ...
  /**
   * Create a Problem object that indicates a client configuration issue.
   *
   * @param title the problem title
   * @param detail the problem detail
   * @return a Problem object with a status of 400 and a type of "about:local"
   */
  public static Problem configProblem(String title, String detail) {
    return new Problem()
        .title(title)
        .detail(detail)
        .data(SENTINEL_MAP)
  ...
  /**
   * Create a Problem object that indicates the a missing feature.
   *
   * @param title the problem title
   * @param detail the problem detail
   * @return a Problem object with a status of 400 and a type of "about:local"
   */
  public static Problem noSuchFeature(String title, String detail) {
    return new Problem()
        .title(title)
        .detail(detail)
        .data(SENTINEL_MAP)
        .status(400)
        .type(MISSING_FEATURE_TYPE);
  }

  /**
   * Create a Problem object that indicates the request never left the client.
   *
   * @param title the problem title
   * @param detail the problem detail
   * @return a Problem object with a status of 400 and a type of "about:local"
  ...
  /**
   * Create a Problem object that indicates the server never sent a problem.
   *
   * @param title the problem title
   * @param detail the problem detail
  ...
  public static Problem noProblemo(String title, String detail, int code) {
    return new Problem()
        ...
        .data(SENTINEL_MAP)
        .status(code)
        .type(MISSING_PROBLEM_TYPE);
  }

  /**
   * Create a problem that indicates an underlying network issue; typically this
  ...
  /**
   * Create a problem that indicates a mismatch in client expectations about what
