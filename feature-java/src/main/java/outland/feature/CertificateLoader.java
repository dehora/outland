...
class CertificateLoader {
  ...
  CertificateLoader(String certificatePath) {
  ...
  private static URL getResourceUrl(String resourceName) {
    ...
    cl = cl == null ? CertificateLoader.class.getClassLoader() : cl;
    URL url = cl.getResource(resourceName);
    FeatureException.throwIfNull(url, "resource not found: " + resourceName);
    return url;
  }
  ...
  private void create(String certificatePath)
      throws FeatureException {
    ...
    Path path = CertificateLoader.resolvePath(certificatePath);
