...
public class FeatureStoreRocksDbTest {
  ...
  public void testDb() throws Exception {
    ...
    Feature feature = Feature.newBuilder().setKey("key1").setGroup("app1").build();

    db.put(feature);

    final FeatureCollection featureCollection = db.findAll("app1");
    assertEquals("key1", featureCollection.getItems(0).getKey());
    assertEquals("app1", featureCollection.getItems(0).getGroup());
  ...
  public void testDbMixedApps() throws Exception {
    ...
    Feature feature2 = Feature.newBuilder().setKey("key2").setGroup("app2").build();
    Feature feature2_ = Feature.newBuilder().setKey("key20").setGroup("app2").build();

    Feature feature3 = Feature.newBuilder().setKey("key3").setGroup("app3").build();
    Feature feature3_ = Feature.newBuilder().setKey("key30").setGroup("app3").build();
  ...
  public void testDbReload() throws Exception {
    ...
    assertEquals("app1", featureCollection1.getItems(0).getGroup());
    ...
    assertEquals("app2", featureCollection2.getItems(0).getGroup());
