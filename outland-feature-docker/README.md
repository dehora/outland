...
| OUTLAND_FEATURE_TABLE_GRAPHS                   | The name of the DynamoDB graphs table. This table stores associations between apps, owners and grants.                      | "dev_outland_namespaces_graph"              | medium     |
| OUTLAND_FEATURE_TABLE_APPS                     | The name of the DynamoDB apps table. This table stores app data.                                                            | "dev_outland_namespaces"                   | medium     |
