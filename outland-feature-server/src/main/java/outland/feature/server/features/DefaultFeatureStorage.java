...
public class DefaultFeatureStorage implements FeatureStorage {
  ...
  private Item preparePutItem(Feature feature) {
    ...
    final Item item = new Item()
        ...
        .withNumber("version_timestamp", feature.getData().getVersion().getTimestamp())
        .withNumber("version_counter", feature.getData().getVersion().getCounter())
        .withString("id", id)
        .withString("status", feature.getData().getStatus().name())
